<template>
    <div class="container">
        ...
        <div class="animate__animated animate__bounceInRight">
            <span class="title" style="display: flex; align-items: center;">Cinema Map 
            <img src="@/assets/icon/map.png" alt="" style="height: 60px; widows: 50px; display: flex; align-items: center; margin-left: 20px;" >
            </span>
        </div>
        <div class="map_wrap" style="width: 90%; margin-left: auto; margin-right: auto; height: 700px;">
                ...
                <div class="option">
                    <div>
                        <form onsubmit="searchPlaces(); return false;">
                            키워드 : <input type="text" v-model="store.mapInfo" id="keyword" size="15"> 
